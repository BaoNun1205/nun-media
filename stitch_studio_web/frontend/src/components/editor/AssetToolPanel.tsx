...
export function AssetToolPanel({ editor }: { editor: EditorController }) {
  return (
    <aside className="editor-left-panel">
      <div className="left-panel-tabs"><button className={editor.assetTab === 'assets' ? 'active' : ''} onClick={() => editor.setAssetTab('assets')}>Assets</button><button className={editor.assetTab === 'tools' ? 'active' : ''} onClick={() => editor.setAssetTab('tools')}>AI Tools</button></div>
